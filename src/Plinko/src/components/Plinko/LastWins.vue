<template>
  ...
  <div
    ...
    <div
      ...
      :key="item.id"
      class="flex  z-[1] aspect-square items-center justify-center text-xs font-bold shadow-[0_3px_var(--shadow-color)] text-[#575757] rounded-[20px] w-[35px] h-[20px] p-[2px] my-1"
